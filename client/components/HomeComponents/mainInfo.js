...
export const mainInfo = () => (
  <div style={blackTextboxContainers}>
    <div style={{ width: '75vw', textAlign: 'left' }} >
      ...
      <div style={{ listStyle: 'none', display: 'flex', flexWrap: 'wrap', justifyContent: 'left', flexDirection: 'row', marginTop: '2em' }}>
      <div style={{marginLeft:'40px'}}>
          <h4>Offering a decrease in</h4>
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', marginLeft: "5%", marginRight: "5%", color: '#f15a29' }}>
        ...
        <div style={{marginLeft:'40px'}}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between',  marginLeft: "5%", marginRight: "5%", marginBottom: '2.5%', color: "#f9931e" }}>
